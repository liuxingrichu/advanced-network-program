...
connection = pika.BlockingConnection(pika.ConnectionParameters(
    '192.168.31.101', 5672, '/', credentials))
...
# For example if send.py program
# was run before. But we're not yet sure which program to run first.
# In such cases it's a good
